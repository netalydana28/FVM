...
class interface:
    ...
    def animate_P(self, i):
        ...
        self.p.contour(self.X_data, self.Y_data, self.P_data, cmap = 'plasma')
        try: 
            self.cb_P.remove()
        except: 
            pass
    ...
    def animate_U(self, i):
        self.u.clear()
        self.read_data()
        self.u.contour(self.X_data, self.Y_data, self.U_data, cmap = 'plasma')
        try: 
            self.cb_U.remove()
        except: 
            pass
    ...
    def animate_V(self, i):
        self.v.clear()
        self.read_data()
        self.v.contour(self.X_data, self.Y_data, self.V_data, cmap = 'plasma')
        try: 
            self.cb_V.remove()
        except: 
            pass
    ...
    def animate_C(self, i):
        self.c.clear()
        self.read_data()
        self.c.contour(self.X_data, self.Y_data, self.C_data, cmap = 'plasma')
        try: 
            self.cb_C.remove()
        except: 
            pass
