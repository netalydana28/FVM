//Circle with triangle mesh: circles 
//Working with input data
#include <bits/stdc++.h>  
using namespace std;
const int node_num=338;
map<int, vector<double> > nodes;
const int center_num=606;
...
void nodes_coor(){
    string myText;
    ifstream NodesFile("coordinates_arb.txt");
    vector<double> v; 
    int cnt = 1;
...
void cell_to_node(){
    string myText;
    ifstream NodesFile("links_arb.txt");
    vector<int> v; 
    vector<int> v1; 
    while (getline(NodesFile, myText)) {
        v = split_int(myText, ' ');
...
void set_boundary_conditions(){
    register int bound1 = 20;
    register int bound2 = 30;
...
int main(){
    ...
    ofstream MyFile("pressure_arb_nodes.dat");
