//Just concentration solving with eps
#include <bits/stdc++.h>  
using namespace std;
...
double nodes[node_num][2], centers[center_num][2], 
    ...
    eps=0.0001, dt = 0.00001, ro = 1.0, d = 2.28917e-008, max_diff, f_volume[center_num];
...
void fvm(){
    for(int main=0; main<1.0e+006; main++){
        ...
        if(main == 8.0e+005){
            ...
            for(int i = 0; i<node_num; i++){
                yFile50000 << nodes[i][0] << " " <<C_nodes[i]<<"\n";
            }
            yFile50000.close();
        }
    }
