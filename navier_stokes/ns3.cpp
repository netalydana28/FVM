...
//cleaning fron unnecessary keys
#include <bits/stdc++.h>  
using namespace std;
...
double nodes[node_num][2], centers[center_num][2], 
    ...
    eps=0.0001, d = 1.0/200.0, dt = 0.001, ro = 1.0, max_diff;
