...
double nodes[node_num][2], centers[center_num][2], 
    ...
    source_coor = lim_x/2;
int face_num, l_cell_to_face[center_num][3], l_cell_to_node[center_num][3], source_node, i, j;
...
void cell_to_vertex_interpolation_old(){ 
    for(int node_ind=1; node_ind<node_num+1; node_ind++){
        ...
        int cell_ind; 
        for(i=0; i<node_to_cell[node_ind-1].size(); i++){ 
