...
#include <bits/stdc++.h>  
using namespace std;
const int node_num=2936;
map<int, vector<double> > nodes;
const int center_num=14177;
...
void nodes_coor(){//checked
    string myText;
    ifstream NodesFile("coor_11.txt");
    vector<double> v; 
    int cnt = 1;
    int cnt_node = 1;
...
void cell_to_node(){//Checked
    string myText;
    ifstream NodesFile("links_11.txt");
    vector<int> v; 
