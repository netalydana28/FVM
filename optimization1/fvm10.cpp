...
#include <bits/stdc++.h>  
using namespace std;
const int node_num=12520, center_num=14416;
...
void nodes_coor(){
    string myText;
    ifstream NodesFile("C:/Users/Eldana/OneDrive - АО Казахстанско-Британский Технический Университет/Documents/Project/fvm/MeshGenerationus/points.txt");
    vector<double> v; 
    int cnt = 0;
...
void cell_to_node(){
    string myText;
    ifstream NodesFile("C:/Users/Eldana/OneDrive - АО Казахстанско-Британский Технический Университет/Documents/Project/fvm/MeshGenerationus/tiangles.txt");
    vector<int> v; 
    while (getline(NodesFile, myText)) {
        v = split_int(myText, ' ');
        int cell = v[0];
